            ...
            <section className="technology lg:py-20 bg-black">
                <div className="container mx-auto md:w-[60%]">
                    <div className="flex flex-col text-center tech-contant">
                        ...
                        <h3 className="md:text-3xl font-semibold uppercase md:mx-auto py-4 lg:leading-relaxed or-font text-white">Accelerating Business Growth With High-Tech Tools And Assets For Ultimate Success</h3>
                        <p class="hasAniTitle lg:text-lg font-normal text-white">
