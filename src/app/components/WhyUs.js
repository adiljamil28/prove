    ...
    return (
        <div>
            ...
            <section className='why-us'>
                <div className="container mx-auto flex lg:flex-row py-14">
                    ...
                    <div className="flex-wrap lg:w-7/12 sm:w-1/2 text-right">
                        ...
                        <h3 class="text-4xl md:text-4xl lg:text-4xl font-white py-4 text-white">Team Strength</h3>
                        </div>
                        ...
                        <h3 class="text-4xl md:text-4xl lg:text-4xl font-white py-4 text-white">Five Star Ratings</h3>
                        </div>
