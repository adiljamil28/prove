...
export const Packages = () => {
  return (
    <div>
        ...
        <div className="grid md:grid-cols-3 md:p-14 md:gap-9 p-5 gap-4">

            <div className="ser border p-4 py-10">
                <h4 className='text-center leading-normal text-4xl text-white stroke-w pb-7'>Package  Name</h4>
              <div className="icon-name flex flex-col-2 items-center" >
                <div className="w-12 h-12 mr-4 inline-flex items-center justify-center rounded-full bg-indigo-100 text-indigo-500 flex-shrink-0">
            ...
            <ul class="list-disc md:p-10 text-xl leading-relaxed text-white">
              ...
              <h3 className='stroke or-color text-4xl'>$4,350.00</h3>
            </div>
